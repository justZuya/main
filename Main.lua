...
local Window = WindUI:CreateWindow({
    ...
    KeySystem = { 
        Key = { "SHWGay", "ilovekira", "Javier Asrahan", "w", "PermKey_0000", "Nobi1705", "EliasGG", "VengadorPrime", "Yaqama", "KEY_Perm10", "pgu245", "AKiLyAs", "NagiTheTester", "LunaPerm", "Diddy", "Wans" },
        Note = "Press Get Key Pls!, I Need Money T_T!",
         Thumbnail = {
          Image = "rbxassetid://122990312323150", -- rbxassetid only
         },
        URL = "https://discord.gg/xzuyaxhub", -- remove this if the key is not obtained from the link.
...
local Tabs = {
    ...
    b = Window:Divider(),
    ServerTab = Window:Tab({ Title = "Server", Icon = "server", Desc = "Subscribe to XZuyaX! " }),
...
Tabs.ButtonTab:Button({
    Title = "No CooldownV2",
    Desc = "Try this if the V1 doesn't work fully",
    Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/XZuuyaX/NoCD/main/StopUsingHack", true))() end
})
...
Tabs.MiscTab:Button({
    Title = "Style Changer Kick Fix",
    Desc = "Reo Needed | Has some bug 🐛",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/XZuuyaX/MSyleC/main/StopHack", true))()
    end
})
